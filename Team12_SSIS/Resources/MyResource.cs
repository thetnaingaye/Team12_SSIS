...
namespace Team12_SSIS.Resources
{
    ...
    public class MyModelResource
    {
        ...
        public HttpResponseMessage<MyModelType> Get(int id)
        {
            ...
            {
                var notFoundResponse = new System.Net.Http.HttpResponseMessage();
                notFoundResponse.StatusCode = HttpStatusCode.NotFound;
                notFoundResponse.Content = new System.Net.Http.StringContent("Item not found");
