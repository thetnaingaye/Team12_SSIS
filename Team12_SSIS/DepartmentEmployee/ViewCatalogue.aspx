...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%">
        <tr>
            <td style="width: 50%">
                <asp:GridView ID="GridViewAddRequest" Style="width:100%" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="8" OnPageIndexChanging="GridViewAddRequest_PageIndexChanging" DataKeyNames="ItemID" CellPadding="4" ForeColor="#333333" GridLines="None" Width="387px">
