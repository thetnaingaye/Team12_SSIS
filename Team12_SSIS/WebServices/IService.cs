...
namespace Team12_SSIS.WebServices
{
    ...
    public interface IService
    {
        ...
        //[OperationContract]
        //[WebInvoke(UriTemplate = "/GetUsersFromDept", Method ="POST", ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        //List<string> GetUsersFromDept(string dept, string token);

        [OperationContract]
        [WebInvoke(UriTemplate = "/GetInventoryList", Method ="POST", ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        List<WCF_InventoryCatalogue> GetInventoryList(string token);

        //[OperationContract]
        //[WebInvoke(UriTemplate = "/SearchInventoryList", Method ="POST" , ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        //List<WCF_InventoryCatalogue> SearchInventoryList(string query, string token);

        //[OperationContract]
        //[WebInvoke(UriTemplate = "/GetStockCard", Method = "POST" , ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        //List<WCF_StockCard> GetStockCard(string itemId, string token);

        [OperationContract]
        [WebInvoke(UriTemplate = "/GetAllRequestsList", Method = "POST", ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        List<WCF_RequisitionRecord> GetStationeryRequests(string token);

        //[OperationContract]
        //[WebInvoke(UriTemplate = "/GetRequestsList", Method ="POST", ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
